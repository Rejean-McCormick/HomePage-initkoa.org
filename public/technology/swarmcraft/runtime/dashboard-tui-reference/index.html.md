...
> Canonical HTML: [https://initkoa.org](https://initkoa.org)/technology/swarmcraft/runtime/dashboard-tui-reference
> Markdown mirror: [https://initkoa.org](https://initkoa.org)/technology/swarmcraft/runtime/dashboard-tui-reference/index.html.md
> Route: /technology/swarmcraft/runtime/dashboard-tui-reference
> Source: app\technology\swarmcraft\runtime\dashboard-tui-reference\page.mdx
> Generated: 2026-06-13T00:42:18.184Z

[Open the HTML page]([https://initkoa.org](https://initkoa.org)/technology/swarmcraft/runtime/dashboard-tui-reference)
...
Matrix reference: **Central Matrix (/technology/swarmcraft/core/central-matrix-runtime-state)**
...
Multi-project: **Multi-Project Management (/technology/swarmcraft/runtime/multi-project-management)**
...
Matrix includes timestamps: **Central Matrix (/technology/swarmcraft/core/central-matrix-runtime-state)**
...
* **Multi-Project Management (/technology/swarmcraft/runtime/multi-project-management)**
