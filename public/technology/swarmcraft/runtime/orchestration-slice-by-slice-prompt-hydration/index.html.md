...
> Canonical HTML: [https://initkoa.org](https://initkoa.org)/technology/swarmcraft/runtime/orchestration-slice-by-slice-prompt-hydration
> Markdown mirror: [https://initkoa.org](https://initkoa.org)/technology/swarmcraft/runtime/orchestration-slice-by-slice-prompt-hydration/index.html.md
> Route: /technology/swarmcraft/runtime/orchestration-slice-by-slice-prompt-hydration
> Source: app\technology\swarmcraft\runtime\orchestration-slice-by-slice-prompt-hydration\page.mdx
> Generated: 2026-06-13T00:42:18.184Z

[Open the HTML page]([https://initkoa.org](https://initkoa.org)/technology/swarmcraft/runtime/orchestration-slice-by-slice-prompt-hydration)
...
Related sources:
- Outline: **Schema Outline (/technology/swarmcraft/scaffold/schema-outline)**
- Template threads/cadence: **Schema Templates (/technology/swarmcraft/scaffold/schema-templates)**
- RAG: **RAG Memory System (/technology/swarmcraft/runtime/rag-memory-system)**
...
Matrix locking semantics: **Central Matrix (/technology/swarmcraft/core/central-matrix-runtime-state)**
...
Template cadence: **Schema Templates (/technology/swarmcraft/scaffold/schema-templates)**
