// app/platforms/konnaxion/technical/konnaxion-technical-architecture-and-services/page.mdx
export const metadata = {
  title: "Konnaxion – Technical Architecture & Services"
};
...
* **Front‑end**: routes reserved per module (`/learn`, `/certs`, `/ethikos/korum`, etc.)
...
* `/ethikos/korum` – Korum Hub (Open / Archived / Start New)
...
* `/ethikos/consult` – Consultation Hub (Live / Results / Suggest)
