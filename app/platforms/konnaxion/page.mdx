      ...
      <div className="max-w-4xl mx-auto px-6 py-16 space-y-20">
        ...
        <section>
          ...
          <p className="text-slate-500 italic mb-8 border-l-2 border-primary pl-4">
            Note: Sub-module pages are currently being migrated. Links will be active once pages are deployed.
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <ul className="space-y-4">
                <li>
                  <span className="font-bold text-slate-800">Knowledge</span>
                  <p className="text-sm text-slate-600">Collaborative Learning Library: catalog, recommendations, co‑creation, forums.</p>
                </li>
                <li>
                  <span className="font-bold text-slate-800">CertifiKation</span>
            ...
            <div>
              ...
              <ul className="space-y-4">
                <li>
                  <span className="font-bold text-slate-800">Korum</span>
                  <p className="text-sm text-slate-600">Structured Debates: topics, −3…+3 stances, threaded arguments, expert cohorts.</p>
                </li>
                <li>
                  <span className="font-bold text-slate-800">Konsultations</span>
            ...
            <div>
              ...
              <ul className="space-y-4">
                <li>
                  <span className="font-bold text-slate-800">Konstruct</span>
                  <p className="text-sm text-slate-600">Project Collaboration: workspaces, tasks, chat, AI insights.</p>
                </li>
                <li>
                  <span className="font-bold text-slate-800">Stockage</span>
            ...
            <div className="md:col-span-2 bg-slate-50 p-6 rounded-sm border border-slate-100">
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div>
                  <span className="font-bold text-slate-800 block mb-1">EkoH</span>
                  <p className="text-sm text-slate-600">Reputation & Expertise: multidimensional scoring, ethical multipliers, audit trails.</p>
                </div>
                <div>
                  <span className="font-bold text-slate-800 block mb-1">Smart Vote</span>
        ...
        <section className="bg-slate-900 text-slate-300 p-8 rounded-sm">
          ...
          <div className="inline-block px-4 py-2 border border-slate-600 rounded text-slate-400 text-sm cursor-not-allowed">
