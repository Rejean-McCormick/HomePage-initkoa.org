...
**Services** * `library_resource_management` – CRUD and classify `KnowledgeResource`; enforce type enum.
...
**Services** * `certification_path_management` – manage `CertificationPath`.
...
**Services** * `structured_debate`, `ai_clone_management`, `comparative_argument_analysis`,
...
**Services** * `public_consultation`, `citizen_suggestion`,
...
**Services** * `digital_archive_management`, `virtual_exhibition`,
...
**Services** * `professional_profile`, `intelligent_matching`,
...
**Services** * `collaboration_space`, `project_task_management`,
...
**Services** * `secure_document_storage`, `document_versioning`,
...
**Services** * `multidimensional_scoring`, `configuration_weights`,
...
**Services** * `dynamic_weighted_vote`, `voting_modalities`,
