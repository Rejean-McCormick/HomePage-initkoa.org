...
1. **Do not change top‑level route ownership** (`/learn`, `/certs`, `/ethikos/korum`, `/consult`, `/projects`, `/kreative`, `/connect`, `/konsensus`, `/reports/smart-vote`) without updating all dependent modules.
