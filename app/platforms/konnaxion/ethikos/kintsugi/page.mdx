...
export const metadata = {
  ...
  description:
    'Kintsugi is how ethiKos delivers a unified civic deliberation pipeline: intake, discovery, deliberation, drafting, decision (Smart Vote), and implementation tracking—without tool capture.',
};
