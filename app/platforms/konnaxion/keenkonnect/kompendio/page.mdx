...
- <Link href="/platforms/konnaxion/keenkonnect/kintsugi" className="text-primary font-bold hover:underline">Open keenKonnect Kintsugi →</Link>  
- <Link href="/platforms/konnaxion/keenkonnect" className="text-primary font-bold hover:underline">Back to keenKonnect →</Link>