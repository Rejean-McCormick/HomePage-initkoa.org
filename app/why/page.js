...
export default function WhyKoaPage() {
  return (
    <PageSection>
      <h1 className="text-4xl font-bold mb-6">Why KOA?</h1>
      ...
      <h2 className="text-2xl font-semibold mb-4">The Diagnosis: Systemic Failure</h2>
      <p className="mb-6">
      ...
      <div className="grid md:grid-cols-2 gap-8 mb-12">
        ...
        <div className="bg-gray-50 p-6 rounded-lg border border-gray-200">
          <h3 className="text-xl font-bold mb-3 text-red-700">Governance & Leadership</h3>
        ...
        {/* Education */}
        <div className="bg-gray-50 p-6 rounded-lg border border-gray-200">
          <h3 className="text-xl font-bold mb-3 text-blue-700">Education & Human Potential</h3>
          <ul className="list-disc pl-5 space-y-2 text-sm">
        ...
        {/* Economy */}
        <div className="bg-gray-50 p-6 rounded-lg border border-gray-200">
          <h3 className="text-xl font-bold mb-3 text-green-700">Economy & Innovation</h3>
          <ul className="list-disc pl-5 space-y-2 text-sm">
        ...
        {/* Justice & Social */}
        <div className="bg-gray-50 p-6 rounded-lg border border-gray-200">
          <h3 className="text-xl font-bold mb-3 text-purple-700">Justice & Society</h3>
          <ul className="list-disc pl-5 space-y-2 text-sm">
      ...
      <h2 className="text-2xl font-semibold mb-4">The Solution: The KOA Ecosystem</h2>
      <p className="mb-6">
      ...
      <div className="space-y-6">
        <div>
          <h3 className="text-lg font-bold">1. Governance via Orgo & Ekoh</h3>
          <p>
        ...
        <div>
          <h3 className="text-lg font-bold">2. Education via The Knowledge Platform</h3>
          <p>
        ...
        <div>
          <h3 className="text-lg font-bold">3. Connection via Konnaxion</h3>
          <p>
        ...
        <div>
          <h3 className="text-lg font-bold">4. Sustainability via Kristal Farms</h3>
          <p>
      ...
      <div className="mt-12 p-6 bg-slate-100 rounded-lg">
        <h2 className="text-xl font-bold mb-2">Our Political Position</h2>
        <p>
