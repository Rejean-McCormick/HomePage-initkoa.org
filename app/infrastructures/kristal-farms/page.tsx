  ...
  return (
    <main className="min-h-screen bg-neutral-50">
      ...
      <section className="bg-[#1e6864] text-white py-24 relative overflow-hidden">
        {/* Abstract background element - lightened brand color for subtle depth */}
        <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-white rounded-full opacity-5 blur-3xl -translate-y-1/2 translate-x-1/3"></div>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <div className="bg-white p-6 rounded-xl border border-slate-100 shadow-sm hover:shadow-md transition-shadow">
            <div className="w-10 h-10 bg-[#1e6864]/10 rounded-lg flex items-center justify-center mb-4">
              <ZapIcon className="w-5 h-5 text-[#1e6864]" />
            </div>
          ...
          <div className="bg-white p-6 rounded-xl border border-slate-100 shadow-sm hover:shadow-md transition-shadow">
            <div className="w-10 h-10 bg-[#1e6864]/10 rounded-lg flex items-center justify-center mb-4">
              <Flame className="w-5 h-5 text-[#1e6864]" />
            </div>
           ...
           <div className="bg-white p-6 rounded-xl border border-slate-100 shadow-sm hover:shadow-md transition-shadow">
            <div className="w-10 h-10 bg-[#1e6864]/10 rounded-lg flex items-center justify-center mb-4">
              <Anchor className="w-5 h-5 text-[#1e6864]" />
            </div>
          ...
          <div className="bg-white p-6 rounded-xl border border-slate-100 shadow-sm hover:shadow-md transition-shadow">
            <div className="w-10 h-10 bg-[#1e6864]/10 rounded-lg flex items-center justify-center mb-4">
              <TrendingUp className="w-5 h-5 text-[#1e6864]" />
            </div>
      ...
      <section id="ecosystem" className="bg-slate-50 py-20 border-t border-slate-200">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <Link href="/infrastructures/kristal-farms/infrastructure" className="group block bg-white rounded-2xl p-8 border border-slate-200 hover:border-[#1e6864] transition-all hover:shadow-lg">
              <div className="flex justify-between items-start mb-4">
                <div className="bg-slate-100 p-3 rounded-lg group-hover:bg-[#1e6864]/10 transition-colors">
                  <Server className="w-8 h-8 text-slate-700 group-hover:text-[#1e6864]" />
                </div>
            ...
            {/* Module 2: Ecology */}
            <Link href="/infrastructures/kristal-farms/ecology" className="group block bg-white rounded-2xl p-8 border border-slate-200 hover:border-[#1e6864] transition-all hover:shadow-lg">
              <div className="flex justify-between items-start mb-4">
                <div className="bg-slate-100 p-3 rounded-lg group-hover:bg-[#1e6864]/10 transition-colors">
                  <Leaf className="w-8 h-8 text-slate-700 group-hover:text-[#1e6864]" />
                </div>
                <ArrowRight className="w-6 h-6 text-slate-300 group-hover:text-[#1e6864]" />
              </div>
            ...
            {/* Module 3: Governance */}
            <Link href="/infrastructures/kristal-farms/governance" className="group block bg-white rounded-2xl p-8 border border-slate-200 hover:border-[#1e6864] transition-all hover:shadow-lg">
              <div className="flex justify-between items-start mb-4">
                <div className="bg-slate-100 p-3 rounded-lg group-hover:bg-[#1e6864]/10 transition-colors">
                  <ShieldCheck className="w-8 h-8 text-slate-700 group-hover:text-[#1e6864]" />
                </div>
                <ArrowRight className="w-6 h-6 text-slate-300 group-hover:text-[#1e6864]" />
              </div>
            ...
            {/* Module 4: Nain Pilot */}
            <Link href="/infrastructures/kristal-farms/nain" className="group block bg-white rounded-2xl p-8 border border-slate-200 hover:border-[#1e6864] transition-all hover:shadow-lg">
              <div className="flex justify-between items-start mb-4">
                <div className="bg-slate-100 p-3 rounded-lg group-hover:bg-[#1e6864]/10 transition-colors">
                  <Snowflake className="w-8 h-8 text-slate-700 group-hover:text-[#1e6864]" />
                </div>
                <ArrowRight className="w-6 h-6 text-slate-300 group-hover:text-[#1e6864]" />
              </div>
