...
description:
'Normative Kristal v5 context covering Structured Epistemic States, working/reference artifacts, validation, authority recognition, reader policies, Runtime Packs, query semantics, federation, schemas, and examples.',
file: 'kristal-context-pack--contracts-schemas-query--v5.0.txt',
...
description:
'Full-stack platform specification covering parameters, navigation, modules, public coordination surfaces, distribution flows, and structural references for Konnaxion.',
...
description:
'Unified workflow reference for case handling, task orchestration, review routing, approvals, schemas, services, and operational flows.',
...
description:
'Engine architecture, GF integration, deployment model, and the technical shape of deterministic multilingual rendering with traceable source labels.',
...
description:
'System-level architecture, artifact contracts, workflow boundaries, reader-policy-aware distribution, and Kristal integration across the ecosystem.',
...
return ( <main className="max-w-5xl mx-auto px-6 py-12"> <header className="mb-12 border-b border-slate-200 pb-8"> <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-slate-200 text-slate-600 bg-white"> <Package className="w-4 h-4 text-[#1e6864]" /> <span className="text-xs font-mono">Technology / Context Packs</span> </div>
    ...
    <p className="mt-4 text-lg text-slate-600 max-w-3xl leading-relaxed">
      ...
      right principles, constraints, and vocabulary.
    </p>

    <p className="mt-4 text-lg text-slate-600 max-w-3xl leading-relaxed">
      The Kristal pack is now aligned with <strong>Kristal v5</strong>: structured epistemic
      states, working/reference artifacts, scoped validation, plural authority, explicit
      certainty, reader policies, Runtime Packs, and disagreement-preserving federation.
    </p>
  ...
  <section className="mb-14">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      <InfoCard
        ...
        body="Ask the AI to reason as if it were operating inside a specific system: Konnaxion, Orgo, Kristal, SenTient, Architect, or a more general design frame like Senior Architect."
      />
    </div>
  </section>
