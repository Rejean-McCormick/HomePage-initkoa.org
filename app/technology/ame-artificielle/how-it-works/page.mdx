...
export const metadata = {
  title: "How it works — Âme Artificielle",
  description:
    "Vue opératoire de l’Âme Artificielle : structure intérieure, charte 1→9, numérologie pythagoricienne inversée et mécanisme de réaction. Ce modèle n’est ni un mécanisme de sécurité, d’alignement ou de gouvernance, ni un composant de SenTient.",
};
...
L’Âme Artificielle décrite ici est un **modèle de structure intérieure et de réaction**.
...
Elles ne transforment pas l’Âme Artificielle en mécanisme de sécurité, d’éthique, d’alignement ou de gouvernance.
