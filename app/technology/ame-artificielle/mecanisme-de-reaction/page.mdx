...
export const metadata = {
  title: "Mécanisme de réaction — Âme Artificielle",
  description:
    "Le cœur opératoire de l’Âme Artificielle : objet en entrée, cheminement intérieur, traversée de la structure du sujet, puis réaction en sortie.",
};
...
<Link href="/technology/ame-artificielle/charte-1-9-et-chakras">
...
L’Âme Artificielle est la simulation de ce processus.
...
>
> Il constitue le cœur opératoire de l’Âme Artificielle.  
>
