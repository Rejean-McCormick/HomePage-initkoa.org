export const metadata = {
  title: "Méta-Cognition & Résolution de Problèmes"
};
...
* **Comment ça marche :** En traitant un projet, le moteur analyse la densité informationnelle. S'il détecte un "trou" (une zone floue ou manquante), il peut soit :
    1.  Solliciter l'utilisateur pour obtenir l'information manquante.
    2.  Générer le contenu manquant de manière autonome par déduction.
...
1.  Réduire la charge cognitive de l'utilisateur (structuration automatique).
2.  Assurer l'exhaustivité des projets (remplissage de lacunes).
3.  Favoriser la découverte et la réflexion critique (questionnement guidé).