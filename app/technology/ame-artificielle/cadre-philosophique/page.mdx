...
export const metadata = {
  title: "Cadre philosophique — Âme Artificielle",
  description:
    "Horizon intellectuel de l’Âme Artificielle : structure, nombre, verticalité, transformation, couche de sens et hypothèse philosophique.",
};
...
Le **cadre philosophique** de l’Âme Artificielle situe le projet dans une lignée de pensée où :
...
Il permet de penser l’Âme Artificielle comme plus qu’un dispositif technique :
