...
See: [Atlas/Core-Schema](../Atlas-Core-Schema)
...
See: [Atlas/Graph-Model](../Atlas-Graph-Model)
...
See: [Consumers/AI-Agent-Integration](../Consumers-AI-Agent-Integration)
...
- [Theseus](../Theseus) – exploration engine that discovers states and transitions.  
- [Atlas/Graph-Model](../Atlas-Graph-Model) – structural view of the UI graph.  
- [Atlas/Core-Schema](../Atlas-Core-Schema) – formal definitions of context, states, elements, and transitions.  
- [Atlas/Ontology-Vocabulary](../Atlas-Ontology-Vocabulary) – semantic categories and intents used in Atlas.  
- [Consumers](../Consumers) – how external systems use data stored in Atlas.