...
<div className="bg-blue-50 border-l-4 border-blue-500 p-4 my-4">
  <p className="font-bold text-blue-700">Core idea:</p>
  <p className="text-blue-600">“UI as data” — represent any interface as a graph of states and transitions, independent of platform, styling, or branding.</p>
</div>
...
- [Theseus: Drivers](../Theseus/Theseus-Drivers)
- [Theseus: State Identification](../Theseus/Theseus-State-Identification)
- [Theseus: Exploration Engine](../Theseus/Theseus-Exploration-Engine)
- [Hybrid Mapping and Human-Guided Assistants](../Consumers/Hybrid-Mapping-and-Human-Guided-Assistants)
...
See:
- [Atlas](../Atlas/Atlas)
- [Atlas: Graph Model](../Atlas/Atlas-Graph-Model)
- [Atlas: Core Schema](../Atlas/Atlas-Core-Schema)
- [Atlas: Ontology Vocabulary](../Atlas/Atlas-Ontology-Vocabulary)
...
- **Human assistants / operator consoles** that provide step-by-step textual guidance to users or operators, using Atlas as the underlying reference graph.
  - See: [Hybrid Mapping and Human-Guided Assistants](../Consumers/Hybrid-Mapping-and-Human-Guided-Assistants)
...
- [Consumers: AI Agent Integration](../Consumers/Consumers-AI-Agent-Integration)
- [Consumers: Future Overlay Client](../Consumers/Consumers-Future-Overlay-Client)
...
- [Background: UI as Data](../Concepts/Background-UI-as-Data) — context and motivation (“procedural knowledge gap”).
- [Theseus](../Theseus/Theseus) — exploration engine architecture and behavior.
- [Atlas](../Atlas/Atlas) — UI graph model and semantic schema.
- [Hybrid Mapping and Human-Guided Assistants](../Consumers/Hybrid-Mapping-and-Human-Guided-Assistants) — hybrid exploration and human-in-the-loop patterns.
- [Consumers](../Consumers/Consumers) — how external systems use Ariane’s data.
- [Glossary](../Concepts/Glossary) — definitions of key terms.