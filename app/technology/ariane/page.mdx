...
- [Background: UI as Data](../Concepts/Background-UI-as-Data) — context and motivation (“procedural knowledge gap”). <!-- cite: 535 -->
- [Theseus](../Theseus/Theseus) — exploration engine architecture and behavior.
- [Atlas](../Atlas/Atlas) — UI graph model and semantic schema. <!-- cite: 536 -->
...
- [Consumers](../Consumers/Consumers) — how external systems use Ariane’s data. <!-- cite: 537 -->
