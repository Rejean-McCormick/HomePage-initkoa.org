...
- **Keyword-based filters**  
  - Skip actions whose labels or descriptions match high-risk patterns (e.g., â€œDeleteâ€, â€œEraseâ€, â€œFormatâ€, â€œResetâ€, â€œUninstallâ€), especially when combined with red styling or warning icons.
...
- **Configurable risk profiles**  
  - Allow running in:
    - â€œSafe modeâ€ â€“ conservative, avoids any destructive-looking action.
    - â€œSandbox modeâ€ â€“ more permissive, for controlled environments such as test VMs.
...
- [Theseus](../theseus) â€“ overview of the exploration engine.  
- [Theseus/State-Identification](../theseus-State-Identification) â€“ how states are fingerprinted and recognized.  
- [Atlas](../atlas) â€“ how the discovered graph is stored and exposed to external systems.  
- [Consumers/AI-Agent-Integration](../consumers-AI-Agent-Integration) â€“ how agents use the resulting graph during guidance.