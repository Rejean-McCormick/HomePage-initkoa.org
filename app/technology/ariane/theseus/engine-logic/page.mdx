...
- [Theseus/State-Identification](../state-identification) – how states are fingerprinted and recognized.  
- [Atlas](../atlas) – how the discovered graph is stored and exposed to external systems.  
- [Consumers/AI-Agent-Integration](../ai-agents) – how agents use the resulting graph during guidance.
