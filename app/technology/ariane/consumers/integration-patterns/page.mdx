...
See: [Consumers/Future-Overlay-Client](../overlay-client)

---

## Related Pages

- [Consumers/AI-Agent-Integration](../ai-agents) – more focused view on AI agents using Ariane.  
- [Atlas](../atlas) – storage and semantic layer that consumers query.  
- [Atlas/Graph-Model](../graph-model) – structural view of states and transitions.  
- [Atlas/core-Schema](../core-schema) – fields available to consumers.  
- [Background-UI-as-Data](../ui-as-data) – motivation for exposing UIs as data.
