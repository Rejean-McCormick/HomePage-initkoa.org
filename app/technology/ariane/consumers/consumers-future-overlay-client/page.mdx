...
- [Consumers](../Consumers) – overview of consumer types, including overlay as one example.  
- [Consumers/AI-Agent-Integration](../Consumers-AI-Agent-Integration) – how agents use Atlas for planning and guidance.  
- [Atlas](../Atlas) – data and semantics that overlay clients would query.  
- [Theseus](../Theseus) – how the underlying UI graphs are discovered in the first place.