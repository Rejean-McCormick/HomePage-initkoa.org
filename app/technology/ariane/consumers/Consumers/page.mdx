...
- [Consumers/AI-Agent-Integration](../Consumers-AI-Agent-Integration) – more focused view on AI agents using Ariane.  
- [Atlas](../Atlas) – storage and semantic layer that consumers query.  
- [Atlas/Graph-Model](../Atlas-Graph-Model) – structural view of states and transitions.  
- [Atlas/Core-Schema](../Atlas-Core-Schema) – fields available to consumers.  
- [Background-UI-as-Data](../Background-UI-as-Data) – motivation for exposing UIs as data.