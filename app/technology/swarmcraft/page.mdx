...
* [**Architecture Overview**](../Core/Architecture-Overview) – High-level diagram of the Brain/Logic/Memory separation.
* [**Deterministic Pipeline**](../Core/Deterministic-Pipeline-Scan-Plan-Execute) – Detailed breakdown of the SCAN-PLAN-EXECUTE control loop.
* [**Prompt Hydration**](../Runtime/Orchestration-Slice-By-Slice-Prompt-Hydration) – How the engine prevents "prompt sprawl" by injecting only the active Part slice.
* [**Provider Adapter: Grok**](../Runtime/Provider-Adapter-Grok) – The normalization layer that keeps the engine model-agnostic.

### State & Schema (The Truth)

* [**Central Matrix**](../Core/Central-Matrix-Runtime-State) – The machine-readable runtime state (`matrix.json`).
* [**Story Bible (Intent)**](../Scaffold/Story-Bible-Creative-Intent) – Where characters, lore, and constraints live.
* [**Story Scaffold**](../Scaffold/Story-Scaffold-Templates-Outline-Parts) – The grid system combining Templates and Outlines.
* [**Schema: Templates**](../Scaffold/Schema-Templates) – Defining thread sets and pacing rules.
* [**Schema: Outline**](../Scaffold/Schema-Outline) – Defining chapters, parts, and beat contracts.

### Operations & Usage

* [**Dashboard TUI**](../Runtime/Dashboard-TUI-Reference) – The "Mission Control" interface for observing the engine.
* [**Multi-Project Management**](../Runtime/Multi-Project-Management) – Running isolated universes in a single runtime.
* [**Outline Grid & CSV**](../Scaffold/Outline-Grid-CSV-Round-Trip) – Round-tripping the story structure via spreadsheets.
* [**RAG Memory System**](../Runtime/RAG-Memory-System) – Long-term retrieval for narrative continuity.
...
* **Full Credits:** [**Read the Credits & Lineage Page**](../Meta/Credits-And-Lineage).