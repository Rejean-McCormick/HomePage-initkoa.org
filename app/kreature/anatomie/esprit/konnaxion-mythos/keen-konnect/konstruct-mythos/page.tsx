// app\kreature\anatomie\esprit\konnaxion-mythos\keen-konnect\konstruct\page.tsx
// app/kreature/anatomie/esprit/konnaxion-mythos/keen-konnect/konstruct/page.tsx
  ...
  return (
    <main className="max-w-4xl mx-auto px-6 py-12">
      ...
      <div className="flex justify-between pt-10 border-t border-slate-200 mt-12">
        ...
        <Link href="/kreature/anatomie/esprit/konnaxion-mythos/keen-konnect/stockage" className="text-cyan-600 hover:text-cyan-800 font-bold flex items-center gap-2 transition-colors">
