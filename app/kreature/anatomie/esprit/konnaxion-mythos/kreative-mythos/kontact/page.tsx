// app\kreature\anatomie\esprit\konnaxion\kreative\kontact\page.tsx
// app/kreature/anatomie/esprit/konnaxion/kreative/kontact/page.tsx
  ...
  return (
    <main className="max-w-4xl mx-auto px-6 py-12">
      ...
      <div className="flex justify-between pt-10 border-t border-slate-200 mt-12">
        <Link href="/kreature/anatomie/esprit/konnaxion/kreative" className="text-slate-500 hover:text-slate-900 font-medium flex items-center gap-2 transition-colors">
          ← Retour à Kreative
        </Link>
        <Link href="/kreature/anatomie/esprit/konnaxion/kreative/konservation" className="text-amber-600 hover:text-amber-800 font-bold flex items-center gap-2 transition-colors">
