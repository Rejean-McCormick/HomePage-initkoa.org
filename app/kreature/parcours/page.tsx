...
export const metadata = {
  ...
  description: "Comment naviguer dans Kréature ? Entrée technique, narrative ou pratique. Choisissez votre porte.",
};
...
const PATHS = [
  ...
  },
  {
    ...
    desc: "Vous cherchez votre reflet. Kréature est un miroir. Découvrez comment votre énergie influence votre interaction avec la machine.",
    href: "/kreature/anatomie/ame/chakras-1-9",
    ...
    <main className="max-w-4xl mx-auto px-6 py-12">
      ...
      <div className="mb-16 border-b border-gray-200 pb-8">
        ...
        <p className="text-xl text-slate-600 max-w-3xl leading-relaxed">
          Kréature est un labyrinthe volontaire. C'est à la fois une documentation technique et une mythologie. 
          Vous n'êtes pas obligés de tout lire. Vous devez juste choisir votre porte.
        </p>
        ...
        <div className="mt-8 bg-slate-50 border-l-4 border-slate-500 p-6 rounded-r-lg">
          ...
          <p className="text-slate-800 italic">
            "Il n'y a pas de bon chemin. Il n'y a que le chemin qui vous ressemble. Voulez-vous voir les câbles ou voulez-vous voir la lumière ?"
          </p>
        </div>
      </div>
      ...
      <section className="bg-slate-900 text-slate-300 p-8 rounded-2xl mb-16 border border-slate-700 shadow-xl">
        ...
        <p className="mb-6 leading-relaxed">
          Ne confondez pas la carte et le territoire. Ce site fonctionne par couches :
        </p>
        <ul className="space-y-4">
          <li className="flex items-start gap-4 p-3 rounded-lg bg-slate-800/50 border border-slate-700">
            ...
            <span>La couche narrative. Elle explique le "Pourquoi" avec des métaphores organiques (ce que vous lisez ici).</span>
          </li>
          <li className="flex items-start gap-4 p-3 rounded-lg bg-slate-800/50 border border-slate-700">
            <span className="text-indigo-400 font-bold min-w-[80px]">2. Tech</span>
            <span>La couche ingénieur. Les liens vers le code, GitHub et les spécifications techniques brutes.</span>
          </li>
          <li className="flex items-start gap-4 p-3 rounded-lg bg-slate-800/50 border border-slate-700">
            <span className="text-emerald-400 font-bold min-w-[80px]">3. UX</span>
            <span>La couche expérience. L'application réelle où vous cliquez et interagissez.</span>
          </li>
        </ul>
      </section>
      ...
      <div className="flex justify-between pt-10 border-t border-slate-200 mt-12">
        <Link href="/" className="text-slate-500 hover:text-slate-900 font-medium flex items-center gap-2 transition-colors">
          ← Accueil
        </Link>
