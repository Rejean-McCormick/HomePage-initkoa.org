      ...
      <div className="max-w-4xl mx-auto">
        ...
        <section className="mb-16">
          <div className="flex items-center mb-6">
            ...
            <h2 className="text-2xl font-bold text-white">The Inverse Surveillance State</h2>
          </div>
...
[Image of public key cryptography diagram]
        ...
        <section className="mb-16">
          <div className="flex items-center mb-6">
            ...
            <h2 className="text-2xl font-bold text-white">The Right to Exit (Forkability)</h2>
          </div>
            ...
            <div className="relative z-10">
              ...
              <ul className="space-y-4">
                <li className="flex items-start">
                  ...
                  <div>
                    <h4 className="font-bold text-white">Data Portability</h4>
                    <p className="text-sm text-slate-400">You own your reputation (Kristals). If you leave the network, you take your verified skills and history with you. No "Platform Lock-in."</p>
                  </div>
                </li>
                <li className="flex items-start">
                  ...
                  <div>
                    <h4 className="font-bold text-white">The Right to Fork</h4>
                    <p className="text-sm text-slate-400">If the governance becomes corrupt, a group of citizens has the code-level right to "Fork" the state—copying the open-source infrastructure to start a parallel community with new rules.</p>
                  </div>
                </li>
              </ul>
            </div>
        ...
        <section className="mb-12">
          ...
          <div className="flex flex-col md:flex-row gap-6 items-center bg-blue-950/30 border border-blue-900/50 rounded-2xl p-8">
            ...
            <div>
              <h3 className="text-lg font-bold text-blue-300 mb-2">Ignorance is a Failure of the State</h3>
