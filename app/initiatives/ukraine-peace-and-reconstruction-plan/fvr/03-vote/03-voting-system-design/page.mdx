...
Voters prove **who they are** and **their home district** (see [Electorate definition](/initiatives/ukraine-peace-and-reconstruction-plan/fvr/03-vote/02-electorate-definition)) using two accepted proofs, at least one showing the home-district address on or before the Reference Date.
