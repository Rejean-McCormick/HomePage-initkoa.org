...
Voters prove **who they are** and **their home district** (see [Electorate definition](../02-electorate-definition)) using two accepted proofs, at least one showing the home-district address on or before the Reference Date.
...
-   [Electorate definition](../02-electorate-definition)
-   [Integrity & observation](../04-integrity-observation)
-   [Dispute resolution](../06-dispute-resolution)