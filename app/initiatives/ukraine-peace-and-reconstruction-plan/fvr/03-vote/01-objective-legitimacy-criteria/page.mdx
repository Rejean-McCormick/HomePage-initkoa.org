...
<!-- source: fvr/03-vote/01-objective-legitimacy-criteria.md -->
...
- Verification gates integration: [`05-governance-and-verification/02-verification-first-gates.md`](../05-governance-and-verification/02-verification-first-gates)
