...
<!-- source: fvr/05-governance-and-verification/04-data-governance-privacy-security.md -->
...
- Vote integrity and observation: [`03-vote/04-integrity-observation.md`](../03-vote/04-integrity-observation)
- Reconstruction transparency: [`04-rebuild/05-accountability-transparency.md`](../04-rebuild/05-accountability-transparency)
- Verification gates: [`05-governance-and-verification/02-verification-first-gates.md`](02-verification-first-gates)
