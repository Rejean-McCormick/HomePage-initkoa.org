export const metadata = {
  title: "Status-neutral governance model"
};
...
- independent audit and inspector-general capacity
- conflict-of-interest disclosure and enforcement
- published rules for emergency changes (rare and time-bounded)
- independent observation/reporting rights
...
- Gate definitions: [`05-governance-and-verification/02-verification-first-gates.md`](/initiatives/ukraine-peace-and-reconstruction-plan/fvr/05-governance-and-verification/02-verification-first-gates)
- Escalation and deconfliction: [`05-governance-and-verification/03-coordination-deconfliction-escalation.md`](/initiatives/ukraine-peace-and-reconstruction-plan/fvr/05-governance-and-verification/03-coordination-deconfliction-escalation)
- Data rules: [`05-governance-and-verification/04-data-governance-privacy-security.md`](/initiatives/ukraine-peace-and-reconstruction-plan/fvr/05-governance-and-verification/04-data-governance-privacy-security)
