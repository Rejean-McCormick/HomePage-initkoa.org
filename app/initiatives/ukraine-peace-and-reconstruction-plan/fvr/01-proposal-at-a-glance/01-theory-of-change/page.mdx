...
Record answers and design choices in the **Decision log** ([`11-appendices/03-decision-log.md`](/initiatives/ukraine-peace-and-reconstruction-plan/fvr/11-appendices/03-decision-log)).