...
- defined area of application (front line, buffer zones, airspace)
...
- Monitoring and incident grading details: [`02-freeze/03-verification-monitoring.md`](/initiatives/ukraine-peace-and-reconstruction-plan/fvr/02-freeze/03-verification-monitoring)
- Deconfliction system design: [`05-governance-and-verification/03-coordination-deconfliction-escalation.md`](/initiatives/ukraine-peace-and-reconstruction-plan/fvr/05-governance-and-verification/03-coordination-deconfliction-escalation)
- Conditional incentives: [`02-freeze/05-sanctions-aid-linkage-during-freeze.md`](/initiatives/ukraine-peace-and-reconstruction-plan/fvr/02-freeze/05-sanctions-aid-linkage-during-freeze)