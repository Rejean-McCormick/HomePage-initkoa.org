...
<!-- source: fvr/04-rebuild/04-economic-restart-plan.md -->
...
(See [`04-rebuild/01-reconstruction-architecture.md`](01-reconstruction-architecture).)

### Transparency and trust
- publish project registries and spending dashboards
- independent audits and debarment rules

(See [`04-rebuild/05-accountability-transparency.md`](05-accountability-transparency).)
...
- [`09-implementation-toolkit/01-operational-checklists-by-phase.md`](../09-implementation-toolkit/01-operational-checklists-by-phase)
- [`09-implementation-toolkit/03-metrics-kpis.md`](../09-implementation-toolkit/03-metrics-kpis)
