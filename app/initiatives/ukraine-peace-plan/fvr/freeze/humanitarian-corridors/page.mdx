...
See:
- incident rubric and monitoring: [`02-freeze/03-verification-monitoring.md`](/initiatives/ukraine-peace-plan/fvr/freeze/verification-monitoring)
...
## Next
- Conditional incentives and linkage to compliance: [`02-freeze/05-sanctions-aid-linkage-during-freeze.md`](/initiatives/ukraine-peace-plan/fvr/freeze/sanctions-linkage)