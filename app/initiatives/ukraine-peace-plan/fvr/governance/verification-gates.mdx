...
See:
- governance model: [`05-governance-and-verification/01-status-neutral-governance-model.md`](/initiatives/ukraine-peace-plan/fvr/governance/status-neutral-model)
...
- clear mapping to the incentives ladder in [`02-freeze/05-sanctions-aid-linkage-during-freeze.md`](/initiatives/ukraine-peace-plan/fvr/freeze/sanctions-linkage),
- links to KPI definitions in [`09-implementation-toolkit/03-metrics-kpis.md`](/initiatives/ukraine-peace-plan/fvr/toolkit/metrics-kpis).