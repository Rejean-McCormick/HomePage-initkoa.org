...
- Voting modalities and identity systems: [`03-vote/03-voting-system-design.md`](/initiatives/ukraine-peace-plan/fvr/vote/voting-system)
- Integrity and observation: [`03-vote/04-integrity-observation.md`](/initiatives/ukraine-peace-plan/fvr/vote/integrity-observation)
...
- Dispute handling: [`03-vote/06-dispute-resolution.md`](/initiatives/ukraine-peace-plan/fvr/vote/dispute-resolution)