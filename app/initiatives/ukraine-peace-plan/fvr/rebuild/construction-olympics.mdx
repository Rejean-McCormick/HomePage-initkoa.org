...
- [`04-rebuild/01-reconstruction-architecture.md`](/initiatives/ukraine-peace-plan/fvr/rebuild/architecture) (governance, procurement, audits)
- [`04-rebuild/05-accountability-transparency.md`](/initiatives/ukraine-peace-plan/fvr/rebuild/accountability) (integrity layer)
...
## Next
- Optional institutional concept: [`04-rebuild/03-peace-build-campus-governance.md`](/initiatives/ukraine-peace-plan/fvr/rebuild/campus-governance)
- Metrics and KPIs toolkit: [`09-implementation-toolkit/03-metrics-kpis.md`](/initiatives/ukraine-peace-plan/fvr/toolkit/metrics-kpis)