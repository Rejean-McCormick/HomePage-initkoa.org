...
- Procurement and governance baseline: [`04-rebuild/01-reconstruction-architecture.md`](/initiatives/ukraine-peace-plan/fvr/rebuild/architecture)
- Performance model: [`04-rebuild/02-reconstruction-olympics.md`](/initiatives/ukraine-peace-plan/concepts/construction-olympics)
...
If this model is adopted, include a short “why this helps” rationale and an explicit “what it does not do” section to prevent misunderstanding. Record the choice in the **Decision log** ([`11-appendices/03-decision-log.md`](/initiatives/ukraine-peace-plan/fvr/appendices/decision-log)).