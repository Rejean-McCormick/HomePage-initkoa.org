// app/initiatives/ukraine-peace-plan/summary/page.mdx
export const metadata = {
  title: "Plan Summary (Index)",
  description: "Complete Table of Contents for the Ukraine Peace & Reconstruction Plan."
};
