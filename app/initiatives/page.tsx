  ...
  return (
    <main className="max-w-6xl mx-auto px-6 py-12">
      ...
      <div className="text-center mb-16">
        {/* CHANGED: text-white -> text-[#1e6864] (Brand Color) */}
        <h1 className="text-5xl font-bold mb-6 text-[#1e6864]">Strategic Initiatives</h1>
        
        {/* CHANGED: text-slate-300 -> text-slate-600 (Darker for visibility on white) */}
        <p className="text-xl text-slate-600 max-w-3xl mx-auto leading-relaxed">
          [cite_start]The KOA project is divided into three layers of action: <span className="font-bold text-[#1e6864]">Theory</span> (The Why), <span className="font-bold text-[#1e6864]">Governance</span> (The How), and <span className="font-bold text-[#1e6864]">Technology</span> (The Engine)[cite: 2].
        </p>
      </div>
      ...
      <section className="mb-20">
        <div className="flex items-center mb-8">
          {/* CHANGED: Unified Icon Backgrounds to Brand Color with low opacity */}
          ...
          <div>
            ...
            [cite_start]<p className="text-slate-500">The practical blueprints for replacing broken institutions[cite: 3].</p>
          </div>
        </div>

        {/* Main Dashboard Link - Card Style Updated */}
        <Link
          ...
          <div className="relative z-10 flex flex-col md:flex-row gap-8 items-start md:items-center justify-between">
            <div className="flex-1">
              ...
              <p className="text-slate-600 text-lg mb-8 leading-relaxed max-w-2xl">
                [cite_start]Access the <strong>Civic Constitution</strong> (The Rules) and the active modules for <strong>Education</strong>, <strong>Economy</strong>, and <strong>Justice</strong>[cite: 4].
              </p>
              
              {/* Module Badges - UNIFIED COLOR SCHEME */}
              {/* Replaced rainbow colors with Brand Color variants */}
      ...
      <section>
        <div className="flex items-center mb-8">
          ...
          <div>
            ...
            [cite_start]<p className="text-slate-500">Geopolitical frameworks for peace and reconstruction[cite: 10].</p>
          </div>
        </div>
        ...
        <div className="grid gap-8 md:grid-cols-1">
          ...
          >
            ...
            <p className="text-slate-600 leading-relaxed mb-6">
              The "Freeze-Vote-Rebuild" framework. [cite_start]Applying technocratic neutrality and the "Construction Olympics" model to geopolitical conflict resolution[cite: 12].
            </p>
